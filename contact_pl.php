...
<body class="hamburger-menu dsn-effect-scroll dsn-ajax" data-dsn-mousemove="true">
    ...
    <div class="preloader">
        ...
        <div class="preloader-block">
            <div class="title"><img src="./assets/img/dark.png"style="width: 20%;"></div>
            <div class="percent">0</div>
            <div class="loading"><img src="./assets/img/quark.png"style="width: 30%;"></div>
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER; // for detailed debug output
    ...
    $mail->Username = 'info@server579372.nazwa.pl'; 
    $mail->Password = 'BE6221ai'; 

    $mail->setFrom('info@server579372.nazwa.pl', 'DarkQuark');
    $mail->addAddress('darkquarksp@gmail.com', 'DarkQuark Admin');
    $mail->addReplyTo($_POST['mail'], $_POST['subject']); 


    $mail->IsHTML(true);
    $mail->Subject = $_POST['subject'];
        $mail->Body    = $_POST['text'] ;
        $mail->Body    .= "<br> Wiadomość została wysłana ze strony DarkQuark.<br>E-mail nadawcy - " ;
        $mail->Body    .= $_POST['mail'] ;
        $mail->Body    .= "<br> Imię nadawcy - " ;
    ...
    echo "Błąd! Wiadomość nie została wysłana. Kod błędu: {$mail->ErrorInfo}";
}
?>
</div></div></div>
 <footer class="footer">
